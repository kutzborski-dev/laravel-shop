<div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
    ...
    <div id="mobile-menu" class="fixed inset-0 z-40 flex hidden">
      <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
            ...
            <ul role="list" class="mt-6 flex flex-col space-y-1">
                <li class="flow-root">
                    <div class="flex items-center justify-between category-menu-item-label--mobile">
                        <a href="#" class="-my-2 py-2 pl-4 text-gray-500 text-lg">
                            Main category
                        </a>
                        <button class="p-4" data-target="main-category">
        ...
        <div class="mt-2">
            <!-- Category tab panel -->
            <div id="main-category-panel" class="category-menu-item-submenu--mobile absolute hidden top-0 h-full w-full bg-white px-4 py-1" aria-labelledby="main-category-panel-tab" role="tabpanel" tabindex="0" data-panel="main-category">
                <div class="grid grid-cols-[25%_50%_25%] border-b-[1px] border-gray-300 items-center mb-3">
                    <div>
                        <button id="main-category-back-btn" type="button" class="p-4 pl-0" aria-role="button" aria-label="Back to menu">
                    ...
                    <div class="text-center">
                        <h3 class="text-xl font-medium">Main category</h3>
                    </div>
                </div>
                <!-- Sub categories -->
